...
private extension ServerSentEvent {
    ...
    static func parseEvent(_ eventString: String, newLineCharacters: [String]) -> ServerSentEvent {
        var event: [String: String?] = [:]
        
        for line in eventString.components(separatedBy: CharacterSet.newlines) as [String] {
            let (akey, value) = ServerSentEvent.parseLine(line, newLineCharacters: newLineCharacters)
