...
final class SSEStreamParser {
    ...
    func append(data: Data?) -> [ServerSentEvent] {
        guard let data = data else { return [] }
        dataBuffer.append(data)
        
        let events = extractEventsFromBuffer().compactMap { [weak self] eventString -> ServerSentEvent? in
            ...
            return ServerSentEvent(
                ...
                newLineCharacters: self.validNewlineCharacters
            )
        }
