...
@MainActor
public class _PostlightParserJS: Logging {
    private let webView = _BKWebView()
    
    public init() async throws {
        let js = try String(contentsOf: Bundle.module.url(forResource: "mercury.web", withExtension: "js")!)
    ...
    public func extract(
        ...
        let script = "return await Mercury.parse(\(url.absoluteString._encodeAsTopLevelJSON()), {html: \(htmlString._encodeAsTopLevelJSON())})"
